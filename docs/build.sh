...
perl -0pi -e 's{(</h1>)}{$1\n<p class="docbar"><span>19 September 2026 · M2, 8 GB, macOS 15</span><a href="/dewfpga/docs/CS223_Mac_Setup.pdf">PDF</a><a href="/dewfpga/templates/Makefile">the five project files</a><span>section 1 prerequisites, 2 the one-line install, 3 the setup by hand, 4 to 8 your lab and the limits</span></p>}' site/docs/index.html
